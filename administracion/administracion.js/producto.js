function obtenerCamposListaPrecio() {
...
var nombreProducto = $("#txtNombreProducto").val();
        ...
        var control = 0;
        $("#tablaListaPrecios").find(':text').each(function() {
var elemento = this;
        if (elemento.value == '') {
alertify.error("mal");
...
alertify.error("bien");
        ...
        var info = "producto=" + nombreProducto + "&marca=" + marca + "&proveedor=" + proveedor + "&codigoProducto=" + codigoProducto + "&costoProducto=" + costoProducto + "&lista=" + lista;
