...
alert("entro");
        ...
        var contador = 0;
                ...
                tr = '<tr>\n\
                        <td> \n\
                        <input id="cant' + contador + '" onkeyup="calcularPorCantidad(' + contador + ');" class="form-control cantidades" type= "text" value="' + elem[ind].cantidadConcepto + '"> </input> </td>\n\
                        <td><span id="codigoM' + contador + '">' + elem[ind].cantidadConcepto + '</span></td>\n\
                        ...
                        <td> <input type="text" id="costo' + contador + '" onkeyup ="calcularPorCosto(' + contador + ')" class="form-control cantidades" value"' + elem[ind].cantidadConcepto + '"> </input>\n\
                        </td>\n\
                        <td> <input id="descuento1' + contador + '" onkeyup="calcularDescuentos(' + contador + ');" class="form-control descuentos" type= "text" value="' + elem[ind].desctUnoConcepto + '"/> </td>\n\
                        <td> <input id="descuento2' + contador + '" onfocus="validarCampoDesc2(' + contador + ');" onkeyup="calcularDescuentos(' + contador + ');" class="form-control descuentos" type= "text" value="' + elem[ind].desctDosConcepto + '"/> </td>\n\
...
function calcularPorCantidad(id) {     var cantPorCantidad = $("#cant" + id).val();
...
var importe;
        ...
        var descuento2 = $("#descuento2" + id).val(); if (descuento1 == '-' || descuento1 == '+' || descuento2 == '-' || descuento2 == '+') {
}
else {
...
if (descuento1 > 0) {
calcularPorCosto(id); importe = $("#importe" + id).val();
...
descuentoProductos = 0;
        ...
        if (isNaN(totalDescuentos)) {         totalDescuentos = 0;
}
...
function validarCampoDesc2(id) {     if ($("#descuento1" + id).val() == '') {
alertify.error("Error! El descuento 1 requerido"); $("#descuento1" + id).focus();
}
}
...
var inf = new Array();
        ...
        var conceptos = new Array(); for (var x = 0; x < parseInt(contador); x++) {             var conceptos = new xmlConceptosManualmente();
...
inf.push(xmlComprobanteManualmente);
        inf.push(lstConceptos); var informacion = JSON.stringify(inf);
        $.ajax({
        type: "POST",
