...
while ($rs = \mysql_fetch_array($datos)) {
    ...
    echo"<td ><button type='button' class='btn btn-xs' value='Detalles' onclick='condicionesPeticion($rs[idEncabezadoRequisicion])'><span class='glyphicon glyphicon-info-sign'></span></button></td></tr>";
}
