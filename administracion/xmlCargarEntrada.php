...
echo "<span>Desct. Factura: </span><input type='text' class='form-control' id='descuentoFactura'  style='width: 15%' />";
echo "<span> Desct. Pronto Pago: </span><input type='text' class='form-control' id='descuentoProntoPago'  style='width: 15%' />";
echo "</form>";
echo "<table id='tblconceptos' class='table table-hover'>";
echo "<thead>";
echo "<th>Cantidad</th><th>Unidad</th><th>Codigo</th><th>Descripcion</th><th>Precio Unitario</th><th>Descuento 1</th><th>Descuento 2</th><th>CDA</th><th>Importe</th>";
echo "</thead>";
echo "<tbody>";
$arrayDetalleEntrada = [];
$cont = 0;
