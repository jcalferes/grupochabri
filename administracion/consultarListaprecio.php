...
echo'<center><button type="button" class="btn btn-xs btn-default" id="btnver" onclick="eliminarListaPrecios()"><span class="glyphicon glyphicon-map-marker"></span></button></center>';
