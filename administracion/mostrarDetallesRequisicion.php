...
echo "<div class='form-control'>Total:  <input type='text' id='costoTotal2' class ='form-control' disabled/><param id= 'sucu' value='$sucu'><param id= 'transf' value='$transferencia'></div>";
