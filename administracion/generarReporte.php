...
<table border ="1">
    ...
    while ($datosOrden = mysql_fetch_array($datos)) {
        ...
        $valor .= '<tr><td style="text-align: right">$' . number_format($datosOrden["cantidadConcepto"], 2) . '</td><td style="text-align: right">$' . number_format($datosOrden["codigoConcepto"] , 2)  . '</td><td style="text-align: right">$' . number_format($datosOrden["descripcionConcepto"], 2)  . '</td><td style="text-align: right">$' .number_format( $datosOrden["precioUnitarioConcepto"], 2) . '</td><td style="text-align: right">$' .number_format($datosOrden["costoCotizacion"], 2)  . '</td><td style="text-align: right">$' . number_format($datosOrden["desctUnoConcepto"], 2) . '</td><td style="text-align: right">$' .number_format($datosOrden["desctDosConcepto"], 2)  . '</td><td style="text-align: right">$' . $datosOrden["totalComprobante"] . '</td><td style="text-align: right">$' .number_format($datosOrden["cdaConcepto"], 2)  . '</td><td style="text-align: right">$' . number_format($datosOrden["importeConcepto"], 2) . '</td></tr>';
